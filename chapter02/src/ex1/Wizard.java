...
public class Wizard {
	...
	// 생성자 오버로딩 
	public Wizard(String name, String tier) {
		
		
	}
	
	public Wizard(String name, String tier, int level, int hp, int power) {
		this.name = name;
		this.tier = tier;
		this.hp = hp;
		this.power = power;
